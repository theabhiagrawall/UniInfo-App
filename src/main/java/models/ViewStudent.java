...
public class ViewStudent {
	...
	public List<ViewStudent> getStudentReport(String collegeid){
		...
		rs=st.executeQuery("select * from studentpersonal where (usertype='student' or usertype='exstudent') and collegeid='"+collegeid+"'");
		ViewStudent vs;
...
public List<ViewStudent> getStudentReport1(String collegeid,String branch){
		...
		con= gc.getConnection();
		Statement st=con.createStatement();
		rs=st.executeQuery("select * from studentpersonal where (usertype='student' or usertype='exstudent') and collegeid='"+collegeid+"' and branch='"+branch+"'");
		ViewStudent vs;
		LoginTracker login=new LoginTracker();
		while(rs.next()) {
