...
else if(request.getAttribute("activity").toString().trim().equals("uploadColgDetails"))
{
	%>
	College Details Registered Successfully...
...
else if(request.getAttribute("activity").toString().trim().equals("uploadColgCutoff"))
{
	%>
	Cutoff Registered Successfully...
...
else if(request.getAttribute("activity").toString().trim().equals("uploadCutoff"))
{
	%>
	Cutoff details Registered Successfully...
	
	<%
}
else if(request.getAttribute("activity").toString().trim().equals("uploadCutoffs"))
{
	%>
